...
public class Conexion {
   ...
   "jdbc:mysql://localhost:3306/peluqueria?useSSL=false&useTimezone=true&serverTimeZone=UTC&allowPublicKeyRetrieval=true";
  ...
  // Método que retorna el objeto DataSource para obtener la conexión
    public static DataSource getDataSource() {
        ...
        if (dataSource == null) {
            ...
            dataSource.setInitialSize(70); // Establece el tamaño inicial de la conexión
        }
        return dataSource;
    }
